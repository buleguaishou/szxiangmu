            ...
            <table class="heard">
                <tr>
                    ...
                    <td colspan="3" style="text-align: left">
                        <el-radio-group style="margin-left: 50px" v-model="form.applicationType" :disabled="type === 'check'">
                            <el-radio v-if="type === 'edit' || (form.applicationType == '公检法' && type === 'check')" label="公检法"
                                >公检法</el-radio
                            >
                            <el-radio v-if="type === 'edit' || (form.applicationType == '律师事务所' && type === 'check')" label="律师事务所"
                                >律师事务所</el-radio
                            >
                            <el-radio v-if="type === 'edit' || (form.applicationType == '其他国家机关' && type === 'check')" label="其他国家机关"
                                >其他国家机关</el-radio
                            >
                        </el-radio-group>
                    </td>
                    ...
                    <td style="text-align: left">
                        <el-checkbox-group style="margin-left: 50px" v-model="form.submitApplicationFlies" :disabled="type === 'check'">
                            <el-checkbox v-if="type === 'edit' || (form.submitApplicationFlies.includes('1') && type === 'check')" label="1"
                                >查询人身份证明</el-checkbox
                            ><br />
                            <el-checkbox v-if="type === 'edit' || (form.submitApplicationFlies.includes('2') && type === 'check')" label="2"
                                >工作证或执行公务的证明文件</el-checkbox
                            ><br />
                            <el-checkbox v-if="type === 'edit' || (form.submitApplicationFlies.includes('3') && type === 'check')" label="3"
                                >授权委托书以及代理人身份证明（委托查询需要提交）</el-checkbox
                            ><br />
                            <el-checkbox v-if="type === 'edit' || (form.submitApplicationFlies.includes('4') && type === 'check')" label="4"
                                >协助查询文件（仅适用国家机关）</el-checkbox
                            ><br />

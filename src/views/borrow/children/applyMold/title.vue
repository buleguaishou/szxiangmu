            ...
            <table class="heard">
                <tr>
                    ...
                    <td style="text-align: left">
                        <span style="margin-left: 50px">不动产权利人</span>
                    </td>
                    <th></th>
                    <td></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <el-input class="paperview-input-text" style="margin-left:34px" :disabled="type === 'check' || showName" v-model="form.applicationName"> </el-input>
                    </td>
                    <th><i>*</i>电话号码</th>
                    <td>
                        <el-input class="paperview-input-text" style="margin-left:34px"  :disabled="type === 'check'" v-model="form.applicationMobile"> </el-input>
                    </td>
                </tr>
                <tr>
                    <th><i>*</i>证件类型</th>
                    ...
                    <th><i>*</i>证件号码</th>
                    <td>
                        <el-input class="paperview-input-text" style="margin-left:34px"  :disabled="type === 'check'" v-model="form.applicationNo">
                        </el-input>
                        <el-button
                            type="primary"
                            style="float: right; margin: -44px 18px 0 0"
                            size="small"
                            @click="getzl"
                            v-if="type === 'edit'"
                        > 获取
                ...
                <tr>
                    <th>代理人</th>
                    <td>
                        <el-input class="paperview-input-text" style="margin-left:34px"  :disabled="type === 'check'" v-model="form.dlrName"> </el-input>
                    </td>
                    <th>电话号码</th>
                    <td>
                        <el-input class="paperview-input-text" style="margin-left:34px"  :disabled="type === 'check'" v-model="form.dlrMobile"> </el-input>
                    </td>
                </tr>
                <tr>
                    <th>证件类型</th>
                    ...
                    <th>证件号码</th>
                    <td>
                        <el-input class="paperview-input-text" style="margin-left:34px"  :disabled="type === 'check'" v-model="form.dlrNo"> </el-input>
                    </td>
                </tr>
            </table>
            <table class="body">
                    ...
                    <td style="text-align: left">
                        <el-checkbox-group style="margin-left: 50px" v-model="form.submitApplicationFlies" :disabled="type === 'check'">
                            ...
                            <el-input
                                ...
                                :disabled="type === 'check'"
                                v-show="form.submitApplicationFlies.includes('6')"
                ...
                <tr style="height: 121px">
                    ...
                    <td style="padding-bottom:20px">
                        <el-upload
                            ...
                            :disabled="type === 'check'"
                        >
                            <el-button v-if="type === 'edit'" icon="el-icon-search" size="small" type="primary" :disabled="type === 'check'"
                                >浏览</el-button
                            >
                        </el-upload>
                    ...
                    <td style="text-align: left">
                        <el-radio-group style="margin-left: 50px" v-model="form.applicationUseType" :disabled="type === 'check'">
                            ...
                            <el-input
                                class="paperview-input"
                                :disabled="type === 'check'"
                                v-show="form.applicationUseType == '8'"
...
import commissionVue from '@/views/commission/commission.vue';
    ...
    methods: {
        ...
        async upfile(params) {
            ...
            if (res.code && res.fileName) {
                const { fileName, fileType, filePath ,signImage, fileFullPath} = res;
                this.fileUploadResults.push({ fileName, fileType, filePath ,signImage, fileFullPath});
                this.srcList.push(fileFullPath)
            } else {
                if (res.code == 110000) {
        ...
        //获取坐落
        async getzl() {
            const res = await service.getzl({
                applicationNo: this.form.applicationNo,
                type: 1
            });
            if (res.code) {
            } else {
                this.form.applicationName = res.applicationName;
                this.form.applicationMobile = res.applicationMobile;
                this.getzlList = res.fileLocationVOS;
                this.showName = true
                this.$nextTick(() => {
                    this.$emit("initEloam", '.sqs')
                })

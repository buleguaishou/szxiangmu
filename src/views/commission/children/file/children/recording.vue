<template>
    <div>
        <table>
          ...
          <tr><th colspan=4 style="height:40px;background: #F5F7FA;border: 1px solid #EBEEF5;">登记信息</th></tr>
            <tr>
                <th>登记机构名称</th>
            ...
            <!-- 权利人信息 -->
        <table>
            <tr><th colspan=6 style="height:40px;background: #F5F7FA;border: 1px solid #EBEEF5;">权利人信息</th></tr>
        ...
        <table>
          <tr><th colspan=4 style="height:40px;background: #F5F7FA;border: 1px solid #EBEEF5;">不动产信息</th></tr>
            <tr>
                <th>不动产类型</th>

        ...
        <div class="container" style="padding-bottom: 100px;">
            <el-form ref="form" :model="search" label-width="80px" label-position="left" class="form-input">
                ...
                <div class="block" style="display:flex;width:40%">
                    <el-input v-model="search.parameter" placeholder="请输入用户姓名、档案号" class="handle-input mr10" @keyup.enter.native="handleSearch"></el-input>
            ...
            >]
                ...
                <el-table-column prop="archiveNo" label="档案号" align="center"></el-table-column>
                <el-table-column prop="operationTime" label="查阅时间" align="center"></el-table-column>
            </el-table>
            <el-pagination
                background
    ...
    methods: {
        ...
        async getauditList() {
            const res = await service.auditList({
                ...
                parameter : this.search.parameter,
